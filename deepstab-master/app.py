...
def detect_inception(net, frame):
    inWidth = 300
    inHeight = 300
    means = (127.5, 127.5, 127.5)
    ratio = 1.0/127.5
...
def detect_mobilenet_openimages_init():
    ...
    pb = "tf_ssd_mobilenet.pb"
    pbtxt = "tf_ssd_mobilenet.pbtxt"
    net = cv2.dnn.readNetFromTensorflow(pb, pbtxt)
    return net
...
if __name__ == '__main__':
    ...
    #mobilenet: fps 7-9, acc 75-100
    detect_method = detect_mobilenet_widerface
    detect_method_init = detect_mobilenet_openimages_init

    #caffe: fps 10-12, acc 30-40
    # detect_method = detect_res10
    # detect_method_init = detect_res10_init

    #faster-cnn: fps  // Const input blob for weights not found in function 'getConstBlob'
    # detect_method_init = detect_fastrcnn
    # detect_method_init = detect_fastrcnn_init

    #ssd_inception: fps 3-4 , acc 51~52
    # detect_method = detect_inception
    # detect_method_init = detect_inception_init
